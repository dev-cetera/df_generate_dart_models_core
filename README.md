[![banner](https://github.com/dev-cetera/df_generate_dart_models_core/blob/v0.9.24/doc/assets/banner.png?raw=true)](https://github.com/dev-cetera)

[![pub](https://img.shields.io/pub/v/df_generate_dart_models_core.svg)](https://pub.dev/packages/df_generate_dart_models_core)
[![tag](https://img.shields.io/badge/Tag-v0.9.24-purple?logo=github)](https://github.com/dev-cetera/df_generate_dart_models_core/tree/v0.9.24)
...
🔍 For more information, refer to the [API reference](https://pub.dev/documentation/df_generate_dart_models_core/).
