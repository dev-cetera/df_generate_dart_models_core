...
abstract mixin class BaseModel {
  ...
  ///
  /// Prefer `==`. Models generated by df_generate_dart_models mix in
  /// `EquatableMixin` and provide value-based equality through the `==`
  /// operator using the same field list, but without the per-call toJson
  /// round-trip this method performs. Retained for one release for
  /// callers still on older generated output.
  @Deprecated(
    'Use the `==` operator instead. Generated models now provide value '
    'equality via EquatableMixin and equals() will be removed in a future '
    'release.',
  )
